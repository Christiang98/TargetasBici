...
const cambioDeImagen = (id) => {
    switch (id) {
        ...
        case "verde":
            ...
            break;
        case "naranja":
            imagenMostrada2.setAttribute("src", `./img/${id}.png`)
            break;
        case "blanca":
            imagenMostrada2.setAttribute("src", `./img/${id}.png`)
            break;
        case "celeste":
            ...
            break;
        case "azul":
            imagenMostrada3.setAttribute("src", `./img/${id}.png`)
            break;
        case "fluor":
            imagenMostrada3.setAttribute("src", `./img/${id}.png`)
            break;
        case "gris":
            ...
            break;
        case "marron":
            imagenMostrada4.setAttribute("src", `./img/${id}.png`)
            break;
        case "cyan":
            imagenMostrada4.setAttribute("src", `./img/${id}.png`)
            break;
        case "bordo":
            ...
            break;
        case "amarillita":
            imagenMostrada5.setAttribute("src", `./img/${id}.png`)
            break;
        case "grisesita":
            imagenMostrada5.setAttribute("src", `./img/${id}.png`)
            break;
        case "blanquita":
            ...
            break;
        case "negra":
            imagenMostrada6.setAttribute("src", `./img/${id}.png`)
            break;
        case "rosa":
            imagenMostrada6.setAttribute("src", `./img/${id}.png`)
            break;
